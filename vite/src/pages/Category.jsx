        ...
        <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header text-center">
              <h3 className="modal-title w-100 fs-5 fw-bold">Tambah Kategori</h3>
              <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div className="modal-body">
              <form>
                <div className="mb-3">
                  <label for="nama-kategori" className="form-label">
                    Nama Kategori
                  </label>
                  <input type="text" className="form-control" id="nama-kategori" />
                </div>
              </form>
            </div>
            <div className="modal-footer">
              <button type="button" className="rounded-pill btn btn-secondary" data-bs-dismiss="modal">
                Batal
              </button>

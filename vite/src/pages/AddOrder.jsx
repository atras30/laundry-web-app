...
export default function AddOrder() {
  ...
  async function fetchCustomers() {
    const customerResponse = await axiosInstance.get(apiBaseUrl("/customers"));
    ...
    <AuthenticatedLayout>
      <MasterLayout>
        <div className="container pb-3">
          <LoadingLayout isLoading={addOrderLoading}>
            <form>
              <div className="mb-3">
                <label htmlFor="exampleDataList" className="form-label fw-bold">
                  Pilih Customer
                </label>
                <LoadingLayout isLoading={customers.length === 0 ? true : false}>
